        ...
        <div className="px-6 py-8">
            ...
            <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="bg-white p-3 rounded border">
                  <div className="text-2xl font-bold text-green-600">{user?.tokens || 0}</div>
          ...
          {currentPass ? (
            <div className="space-y-6">
              ...
              {!currentPass.mined && !currentPass.expired && (
                <div className="bg-yellow-50 border border-yellow-300 text-yellow-700 px-4 py-3 rounded-md text-center">
                  <p className="text-sm">
            ...
            <div className="text-center py-12">
              ...
              >
                <path
                  ...
                  strokeWidth="1"
                  d="M12 4v1m6 11h2m-6 0h-2v4m0-11v3m0 0h.01M12 12h4.01M12 15h4.01M12 21h4.01M12 12h4.01M12 15h4.01M12 21h4.01M12 12h4.01M12 15h4.01M12 21h4.01M12 12h4.01M12 15h4.01M12 21h4.01M12 12h4.01M12 15h4.01M12 21h4.01M12 12h4.01M12 15h4.01M12 21h4.01M12 12h4.01M12 15h4.01M12 21h4.01"
                />
              </svg>
