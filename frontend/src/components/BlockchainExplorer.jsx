        ...
        <div className="flex justify-between items-start">
          <div>
            ...
            <p className="mt-2 text-sm text-gray-600">
              View all blocks, transactions, and blockchain data
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white shadow overflow-hidden sm:rounded-md">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200">
              ...
              <p className="mt-1 max-w-2xl text-sm text-gray-500">
                Blockchain blocks in reverse chronological order
              </p>
            </div>

            <ul className="divide-y divide-gray-200">
              {blocks.map((block) => (
                <li key={block.index} className="px-4 py-4">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-yellow-50 border border-yellow-300 rounded-lg p-4">
            <h4 className="text-sm font-medium text-yellow-800 mb-2">How Mining Works</h4>
